...
for k = 1:length(features)
    ...
    elseif isequal(features{k}.getFeature, @get_saab)
        features{k}.is_cell = false;
        features{k}.is_cnn = false;
        if is_color_image
            features{k}.fparams.colorspace = 'rgb';
            features{k}.fparams.nDim = features{k}.fparams.ksize*features{k}.fparams.ksize*3 * features{k}.fparams.conca * features{k}.fparams.conca;
        else
            features{k}.fparams.colorspace = 'gray';
            features{k}.fparams.nDim = features{k}.fparams.ksize*features{k}.fparams.ksize * features{k}.fparams.conca * features{k}.fparams.conca;
            %features{k}.fparams.num_kernel = 32;
        end
        if features{k}.fparams.nDim > (features{k}.fparams.num_kernel * features{k}.fparams.conca * features{k}.fparams.conca)
            features{k}.fparams.nDim = (features{k}.fparams.num_kernel * features{k}.fparams.conca * features{k}.fparams.conca);
        end
